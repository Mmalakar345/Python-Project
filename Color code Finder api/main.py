# All functions , librarys imports
...
# A color line top on the display
Label(root,width=120,height=10,bg="#4272f9").pack()

# Frame creation under display
frame=Frame(root,width=700,height=370,bg="#fff")
frame.place(x=50,y=50)

# Color theme logo creation
logo=PhotoImage(file="Image\logo.png")
Label(frame,image=logo,bg="#fff").place(x=10,y=10)

# Color finder heading write
Label(frame,text="Color Finder",font="arial 25 bold",bg="white").place(x=100,y=20)



#############################  Color box 1Column 1 
colors=Canvas(frame,bg="#fff",width=150,height=265,bd=1)
colors.place(x=20,y=93)

#color boxes column 1 
id1 = colors.create_rectangle((10,5,50,50),fill="#b8255f")
...
# color code name Text write section 
...
#############################  Color box column  2 
colors2=Canvas(frame,bg="#fff",width=150,height=265,bd=1)
colors2.place(x=180,y=93)

#color boxes column 2 
id6 = colors2.create_rectangle((10,5,50,50),fill="#7ecc49")
...
######################### Button creation #######################
# select image button working function
def showimage():
    global filename
    ...
    lbl.image=img
# Select image button
Button(selectimage,text="Select Image",width=12,height=1,bg="lightgreen",font="arial 14 bold",command=showimage).place(x=10,y=300)

# find color button working function
def findcolors():
    # global filename
    ...
    # column 1 hex value to color shown in display
    ...
    # column 2 hex value to color shown in display
    ...
    # hex value show beside there respected colors
    ...
    print("We are Sucessfully Find colors")
    
    

# Find color button
Button(selectimage,text="Find Colors",width=12,height=1,bg="lightgreen",font="arial 14 bold",command=findcolors).place(x=176,y=300)
